...
from james_burvel_ocallaghan_iii._streaming import Stream, AsyncStream, ServerSentEvent


@pytest.mark.asyncio
@pytest.mark.parametrize("sync", [True, False], ids=["sync", "async"])
async def test_basic(sync: bool, client: JamesBurvelOcallaghanIii, async_client: AsyncJamesBurvelOcallaghanIii) -> None:
...
async def test_data_missing_event(
    sync: bool, client: JamesBurvelOcallaghanIii, async_client: AsyncJamesBurvelOcallaghanIii
) -> None:
    def body() -> Iterator[bytes]:
        yield b'data: {"foo":true}\n'
        yield b"\n"

...
class TestTreasury:
    ...
    @parametrize
    def test_method_get_liquidity_positions(self, client: JamesBurvelOcallaghanIii) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_get_liquidity_positions(self, client: JamesBurvelOcallaghanIii) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_streaming_response_get_liquidity_positions(self, client: JamesBurvelOcallaghanIii) -> None:
...
class TestAsyncTreasury:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_get_liquidity_positions(self, async_client: AsyncJamesBurvelOcallaghanIii) -> None:
        treasury = await async_client.corporate.treasury.get_liquidity_positions()
        assert_matches_type(TreasuryGetLiquidityPositionsResponse, treasury, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_raw_response_get_liquidity_positions(self, async_client: AsyncJamesBurvelOcallaghanIii) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_streaming_response_get_liquidity_positions(

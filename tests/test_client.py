...
class TestJamesBurvelOcallaghanIii:
    ...
    def test_raw_response(self, respx_mock: MockRouter, client: JamesBurvelOcallaghanIii) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_raw_response_for_binary(self, respx_mock: MockRouter, client: JamesBurvelOcallaghanIii) -> None:
    ...
    def test_copy_build_request(self, client: JamesBurvelOcallaghanIii) -> None:
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "james_burvel_ocallaghan_iii/_legacy_response.py",
                        "james_burvel_ocallaghan_iii/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "james_burvel_ocallaghan_iii/_compat.py",
    ...
    def test_default_headers_option(self) -> None:
        test_client = JamesBurvelOcallaghanIii(
            base_url=base_url, _strict_response_validation=True, default_headers={"X-Foo": "bar"}
        )
        ...
        test_client2 = JamesBurvelOcallaghanIii(
            base_url=base_url,
    ...
    def test_hardcoded_query_params_in_url(self, client: JamesBurvelOcallaghanIii) -> None:
    ...
    def test_request_extra_json(self, client: JamesBurvelOcallaghanIii) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_request_extra_headers(self, client: JamesBurvelOcallaghanIii) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_request_extra_query(self, client: JamesBurvelOcallaghanIii) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_multipart_repeating_array(self, client: JamesBurvelOcallaghanIii) -> None:
        request = client._build_request(
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_binary_content_upload(self, respx_mock: MockRouter, client: JamesBurvelOcallaghanIii) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_basic_union_response(self, respx_mock: MockRouter, client: JamesBurvelOcallaghanIii) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_union_response_different_types(self, respx_mock: MockRouter, client: JamesBurvelOcallaghanIii) -> None:
    ...
    @pytest.mark.parametrize(
        "client",
        [
            JamesBurvelOcallaghanIii(base_url="http://localhost:5000/custom/path/", _strict_response_validation=True),
            JamesBurvelOcallaghanIii(
    ...
    def test_base_url_trailing_slash(self, client: JamesBurvelOcallaghanIii) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: JamesBurvelOcallaghanIii) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: JamesBurvelOcallaghanIii) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_client_response_validation_error(self, respx_mock: MockRouter, client: JamesBurvelOcallaghanIii) -> None:
        class Model(BaseModel):
            foo: str
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = JamesBurvelOcallaghanIii(base_url=base_url, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        non_strict_client = JamesBurvelOcallaghanIii(base_url=base_url, _strict_response_validation=False)
    ...
    def test_parse_retry_after_header(
        self, remaining_retries: int, retry_after: str, timeout: float, client: JamesBurvelOcallaghanIii
    ) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_follow_redirects(self, respx_mock: MockRouter, client: JamesBurvelOcallaghanIii) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_follow_redirects_disabled(self, respx_mock: MockRouter, client: JamesBurvelOcallaghanIii) -> None:
...
class TestAsyncJamesBurvelOcallaghanIii:
    @pytest.mark.respx(base_url=base_url)
    async def test_raw_response(self, respx_mock: MockRouter, async_client: AsyncJamesBurvelOcallaghanIii) -> None:
        respx_mock.post("/foo").mock(return_value=httpx.Response(200, json={"foo": "bar"}))
    ...
    @pytest.mark.skipif(sys.version_info >= (3, 10), reason="fails because of a memory leak that started from 3.12")
    def test_copy_build_request(self, async_client: AsyncJamesBurvelOcallaghanIii) -> None:
        options = FinalRequestOptions(method="get", url="/foo")
    ...
    async def test_hardcoded_query_params_in_url(self, async_client: AsyncJamesBurvelOcallaghanIii) -> None:
    ...
    def test_multipart_repeating_array(self, async_client: AsyncJamesBurvelOcallaghanIii) -> None:
        request = async_client._build_request(
            FinalRequestOptions.construct(
                method="post",
                url="/foo",
    ...
    async def test_binary_content_upload_with_asynciterator(self) -> None:
        ...
        async with AsyncJamesBurvelOcallaghanIii(
            base_url=base_url,
            _strict_response_validation=True,
    ...
    async def test_base_url_env(self) -> None:
        with update_env(JAMES_BURVEL_OCALLAGHAN_III_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncJamesBurvelOcallaghanIii(_strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    async def test_base_url_trailing_slash(self, client: AsyncJamesBurvelOcallaghanIii) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    async def test_base_url_no_trailing_slash(self, client: AsyncJamesBurvelOcallaghanIii) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    async def test_absolute_request_url(self, client: AsyncJamesBurvelOcallaghanIii) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncJamesBurvelOcallaghanIii(base_url=base_url, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        non_strict_client = AsyncJamesBurvelOcallaghanIii(base_url=base_url, _strict_response_validation=False)
    ...
    async def test_parse_retry_after_header(
        self, remaining_retries: int, retry_after: str, timeout: float, async_client: AsyncJamesBurvelOcallaghanIii
    ) -> None:
        headers = httpx.Headers({"retry-after": retry_after})
        options = FinalRequestOptions(method="get", url="/foo", max_retries=3)
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_follow_redirects(self, respx_mock: MockRouter, async_client: AsyncJamesBurvelOcallaghanIii) -> None:
        # Test that the default follow_redirects=True allows following redirects
        respx_mock.post("/redirect").mock(
            return_value=httpx.Response(302, headers={"Location": f"{base_url}/redirected"})
        )

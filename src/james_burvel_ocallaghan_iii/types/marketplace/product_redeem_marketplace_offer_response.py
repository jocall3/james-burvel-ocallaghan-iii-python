...
class ProductRedeemMarketplaceOfferResponse(BaseModel):
    associated_transaction_id: Optional[str] = FieldInfo(alias="associatedTransactionId", default=None)
    """
    ...
    offer_id: Optional[str] = FieldInfo(alias="offerId", default=None)
    """The ID of the redeemed offer."""

    redemption_date: Optional[datetime] = FieldInfo(alias="redemptionDate", default=None)

    redemption_id: Optional[str] = FieldInfo(alias="redemptionId", default=None)

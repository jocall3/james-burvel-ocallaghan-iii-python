...
class ScenarioResultLiquidityMetrics(BaseModel):
    min_cash_balance: Optional[object] = FieldInfo(alias="minCashBalance", default=None)
    """Minimum cash balance reached during the scenario."""

    recovery_time_months: Optional[object] = FieldInfo(alias="recoveryTimeMonths", default=None)
    """Time in months to recover to pre-event financial state."""


class ScenarioResultSensitivityAnalysisGraphData(BaseModel):
    outcome_value: Optional[object] = FieldInfo(alias="outcomeValue", default=None)

    param_value: Optional[object] = FieldInfo(alias="paramValue", default=None)


class ScenarioResultSensitivityAnalysisGraph(BaseModel):
    data: Optional[List[ScenarioResultSensitivityAnalysisGraphData]] = None

    param_name: Optional[object] = FieldInfo(alias="paramName", default=None)
...
class ScenarioResult(BaseModel):
    ...
    scenario_name: object = FieldInfo(alias="scenarioName")
    ...
    final_net_worth_projected: Optional[object] = FieldInfo(alias="finalNetWorthProjected", default=None)
...
class AdvancedSimulationResponse(BaseModel):
    overall_summary: object = FieldInfo(alias="overallSummary")

...
from ...types.transaction_dispute_response import TransactionDisputeResponse
...
class TransactionsResource(SyncAPIResource):
    ...
    def dispute(
        ...
        *,
        ...
        return self._post(
            ...
            cast_to=TransactionDisputeResponse,
        )
    ...
    def update_notes(
        ...
        *,
        ...
        Args:
          notes: The personal notes to add or update for the transaction.

...
class PasswordResetResource(SyncAPIResource):
    ...
    def confirm(
        ...
        *,
        ...
        Args:
          identifier: User's email or phone number used for verification.

          new_password: The new password for the user account.

          verification_code: The verification code received via email or SMS.
    ...
    def initiate(
        ...
        *,
        ...
        Args:
          identifier: User's email or phone number for verification.

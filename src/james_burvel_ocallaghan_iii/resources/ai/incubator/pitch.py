...
from ....types.ai.incubator import pitch_submit_params, pitch_submit_feedback_params
from ....types.ai.incubator.quantum_weaver_state import QuantumWeaverState
...
class PitchResource(SyncAPIResource):
    ...
    def submit(
        ...
        *,
        ...
        Args:
          business_plan: The user's detailed narrative business plan (e.g., executive summary, vision,
              strategy).

          financial_projections: Key financial metrics and projections for the next 3-5 years.

          founding_team: Key profiles and expertise of the founding team members.

          market_opportunity: Detailed analysis of the target market, problem statement, and proposed
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                pitch_submit_params.PitchSubmitParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=QuantumWeaverState,
        )
        ...
        *,
        ...
        return self._put(
            ...
            body=maybe_transform(
                ...
                pitch_submit_feedback_params.PitchSubmitFeedbackParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
